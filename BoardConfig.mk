...
# Partitions
ifneq ($(WITH_GMS),true)
BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := 3133369344
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 688823296
BOARD_SYSTEM_EXTIMAGE_PARTITION_RESERVED_SIZE := 731442176
endif
